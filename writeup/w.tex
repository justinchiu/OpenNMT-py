...
\begin{tikzpicture}
\node(yt)[latent]{$y_t$};
\node(xt)[det, left =of yt]{$\tilde\bx_t$};
\node(at)[latent, below =of yt]{$a_t$};
...
\begin{tikzpicture}
\node(y)[latent]{$y_t$};
\node(x)[det, left =of yt]{$\tilde\bx_t$};
\node(z)[det, below =of yt]{$a_t$};
%\node(xt)[det,    right =of st]{$\tilde\bx_t$};
\node(st)[latent, left =of at]{$s_t$};
\node(ap)[latent, below =of st]{$a_{t-1}$};
\node(ah)[latent, below =of at]{$\hat{a}_t$};
